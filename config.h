...
static Key keys[] = {
    ...
    {MODKEY,              XK_e,       spawn,           SHCMD("sdt")},
    {MODKEY,              XK_r,       spawn,           SHCMD("dunstctl history-pop")},
    {MODKEY,              XK_t,       spawn,           SHCMD("otp")},
    {MODKEY,              XK_x,       spawn,           SHCMD("dmenuunicode")},
    {MODKEY,              XK_c,       spawn,           SHCMD("colorpick")},
    {MODKEY,              XK_z,       spawn,           {.v = (const char*[]){ "passmenu", NULL } } },
    // {MODKEY,              XK_c,       spawn,           SHCMD(TERMINAL " -e ncmpcpp")},
    {MODKEY,              XK_n,       spawn,           SHCMD(TERMINAL " --working-directory ~/notes/todo -e nvim daily")},
    {MODKEY,              XK_m,       spawn,           SHCMD(TERMINAL " -e aerc")},
    // Special
    {MODKEY | ShiftMask,  XK_q,       quit,            {0}},

    // Window Switching
    TAGKEYS(XK_a, 0) TAGKEYS(XK_s, 1) TAGKEYS(XK_d, 2) TAGKEYS(XK_f, 3)
    TAGKEYS(XK_g, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
    TAGKEYS(XK_9, 8)
    };
